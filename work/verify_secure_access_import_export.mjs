...
try {
  ...
  assert.equal(await page.locator("#authLogin").textContent(), "Email Secure Access Link");
  ...
  await page.locator("#starfleetLoginVisible").check();
  ...
  await enabledPage.locator("#starfleetLoginVisible").check();
